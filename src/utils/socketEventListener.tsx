...
type MessageEvents = {
      ...
      answer: (description: RTCSessionDescriptionInit) => void;
      iceCandidate: (iceCandidate: RTCIceCandidateInit) => void;
};
type WebRtcEmits = {
      createOffer: (description: RTCSessionDescriptionInit) => void;
      'join-to-voice': (guild: string) => void;

      createAnswer: (description: RTCSessionDescriptionInit) => void;

      addIceCandidate: (iceCandidate: RTCIceCandidateInit) => void;
};
type DefaultEventsMap = MessageEvents;
